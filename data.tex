...
The code used for data cleaning, analysis, modeling, and figure generation, along with the cleaned CSV file, is available at: \url{https://github.com/yourusername/yourrepo} % Replace with your actual link
\end{document}